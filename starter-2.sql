...
-- Dumping structure for table my-project.jenis_perniagaan
CREATE TABLE IF NOT EXISTS `jenis_perniagaan` (
  `id` int NOT NULL AUTO_INCREMENT,
  `jenis` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table my-project.jenis_perniagaan: ~4 rows (approximately)
INSERT INTO `jenis_perniagaan` (`id`, `jenis`) VALUES
	(1, 'makanan'),
	(2, 'minuman'),
	(3, 'pakaian'),
	(4, 'aksesori komputer');

-- Dumping structure for table my-project.permohonan
CREATE TABLE IF NOT EXISTS `permohonan` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nama` varchar(255) DEFAULT NULL,
  `nokp` varchar(20) DEFAULT NULL,
  `tapak` varchar(50) DEFAULT NULL,
  `jenis_perniagaan` int DEFAULT NULL,
  `status` enum('baru','telah disemak','lulus','gagal') DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `semak_oleh` int DEFAULT NULL,
  `tarikh_semak` datetime DEFAULT NULL,
  `tarikh_lulus` datetime DEFAULT NULL,
  `dilulus_oleh` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `dilulus_oleh` (`dilulus_oleh`),
  KEY `semak_oleh` (`semak_oleh`),
  KEY `jenis_perniagaan` (`jenis_perniagaan`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table my-project.permohonan: ~0 rows (approximately)
...
-- Dumping data for table my-project.users: ~6 rows (approximately)
